      ...
      <div class="col-md-6">
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h6 class="panel-title txt-dark">Tambah Data <?php echo $JabatanController->initial; ?></h6>
            </div>
                  ...
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $JabatanController->path_controller; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jbtn_nama" data-error="Data nama jabatan harus diisi" required>
