      ...
      <div class="col-md-6">
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h6 class="panel-title txt-dark">Tambah Data <?php echo $UpahController->initial; ?></h6>
            </div>
                  ...
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $UpahController->path_controller; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="upah_satuan" data-error="Data satuan upah harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        <label for="upah_harga" class="control-label mb-10">Harga</label>
                        <div class="input-group"> <span class="input-group-addon">Rp</span>
                          <input type="number" class="form-control" name="upah_harga" data-error="Data harga upah harus diisi" required>
