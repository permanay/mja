                  ...
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $PegawaiController->path_controller; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="peg_nama" data-error="Data nama lengkap harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        <label for="peg_email" class="control-label mb-10">Email</label>
                        <input type="email" class="form-control" name="peg_email" data-error="Data email salah" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        <label for="peg_no_tlp" class="control-label mb-10">No Telepon</label>
                        <input type="text" class="form-control" name="peg_no_tlp" data-error="Data no telepon harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        <label for="peg_domisili" class="control-label mb-10">Domisili</label>
                        <input type="text" class="form-control" name="peg_domisili" data-error="Data domisili harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                      ...
                      <div id="user" style="display: inherit;">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="pgna_username" id="pgna_username" data-error="Data username harus diisi" required>
                          <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                          <label for="pgna_sandi" class="control-label mb-10">Sandi</label>
                          <input type="password" class="form-control" name="pgna_sandi" id="pgna_sandi" data-error="Data sandi harus diisi" required>
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
