      ...
      <div class="col-md-6">
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h6 class="panel-title txt-dark">Tambah Data <?php echo $PekerjaanController->initial; ?></h6>
            </div>
                  ...
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $PekerjaanController->path_controller; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pek_nama" data-error="Data nama pekerjaan harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        <label for="pek_satuan" class="control-label mb-10">Satuan Pekerjaan</label>
                        <input type="text" class="form-control" name="pek_satuan">
                      </div>
