      ...
      <div class="col-md-6">
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h6 class="panel-title txt-dark">Import Data <?php echo $BahanBakuController->initial; ?></h6>
            </div>
          ...
          <div class="panel-wrapper collapse in">
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $BahanBakuController->path_controller; ?>" method="POST" enctype="multipart/form-data">
