      ...
      <div class="col-md-6">
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h6 class="panel-title txt-dark">Tambah Data <?php echo $RisikoController->initial; ?></h6>
            </div>
                  ...
                  <div class="form-wrap">
                    <form data-toggle="validator" role="form" action="<?php echo $RisikoController->path_controller; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="rsko_nama" data-error="Data nama risiko harus diisi" required>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                        ...
                        <select class="selectpicker" data-style="form-control btn-default btn-outline" name="rsko_nilai_dampak" data-error="Data dampak risiko harus diisi" required>
                          <option value="0,8">Menyebabkan kematian, kerugian yang sangat besar</option>
                          <option value="0,6">Kecelakaan berat, kehilangan kemampuan operasi/ produksi, kerugian materi yang tinggi</option>
                          <option value="0,4">Diharuskan penanganan secara medis, kerugian materi yang cukup tinggi</option>
                          <option value="0,2">Bantuan kecelakaan awal, kerugian materi yang medium</option>
                          <option value="0,05">Tanpa kecelakaan manusia, kerugian materi</option>
                        </select>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="rsko_pengendalian" data-error="Data pengendalian risiko harus diisi" required></textarea>
                        <div class="help-block with-errors"></div>
                      </div>
