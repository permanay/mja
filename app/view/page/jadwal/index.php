    ...
    <script type="text/javascript">
        ...
        function drawNetwork() {
          var nodes = [
            <?php
              foreach ($data['vis'][0] as $v) {
            ?>
                {id: <?php echo $v; ?>, shape: 'dot', color:{background:'#ffffff', border:'black'}},
            <?php
              }
            ?>
          ];
          ...
          var edges = [
            <?php
              foreach ($data['vis'][1] as $v) {
            ?>
                {from: <?php echo $v['from']; ?>, to: <?php echo $v['to']; ?>, label: '<?php echo $v['label']; ?>', arrows:'to', color:{color:'<?php echo $v['color']; ?>'}},
            <?php
              }
            ?>
          ]
