<?php
	...
	class Bahan_baku extends Database{

		private $table = "bahan_baku";
		private $primary = "bhnbku_id";
		private $field = array(
									'bhnbku_id',
									'bhnbku_nama',
									'bhnbku_satuan',
	    ...
	    public function getDataBahan_baku($pryk_id){
	    	$result = $this->raw("SELECT * FROM `Bahan_baku` a JOIN `proyek` b on a.`pryk_id` = b.`pryk_id` where a.`pryk_id` = '$pryk_id'");
	     	return $result;
	    }

	    public function getDataBahan_bakuByID($id){
	    	$result = $this->raw("SELECT * FROM `Bahan_baku` a JOIN `proyek` b on a.`pryk_id` = b.`pryk_id` where a.`peg_id` = '$id' ");
	     	return $result;
	    }
