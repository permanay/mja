<?php
	...
	class Kegiatan_harian_risiko extends Database{

		private $table = "kegiatan_harian_risiko";
		private $primary = "kgtnrsko_id";
		private $field = array(
									'kgtnrsko_id',
									'kgtnhari_id',
									'rsko_id',
	    ...
	    public function getDataKegiatanHarianRisiko($kgtnhari_id){
	    	$result = $this->raw("SELECT * FROM `kegiatan_harian_risiko` a JOIN `kegiatan_harian` b on a.`kgtnhari_id` = b.`kgtnhari_id` JOIN `risiko` c on a.`rsko_id` = c.`rsko_id` WHERE `kgtnhari_id` = 'kgtnhari_id'");
	     	return $result;
	    }
	    ...
	    public function getDataKegiatan_harian_risikoByID($id){
	    	$result = $this->raw("SELECT * FROM `kegiatan_harian_risiko` a LEFT JOIN `pengguna` b on a.`pgna_id` = b.`pgna_id` JOIN `jabatan` c on a.`jbtn_id` = c.`jbtn_id` where a.`peg_id` = '$id' ");
	     	return $result;
	    }
