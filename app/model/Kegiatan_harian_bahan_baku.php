<?php
	...
	class Kegiatan_harian_bahan_baku extends Database{

		private $table = "kegiatan_harian_bahan_baku";
		private $primary = "kgtnbhnbku_id";
		private $field = array(
									'kgtnbhnbku_id',
									'kgtnhari_id',
									'bhnbku_id',
	    ...
	    public function getDataKegiatanHarianBahanBaku($kgtnhari_id){
	    	$result = $this->raw("SELECT * FROM `Kegiatan_harian_bahan_baku` a JOIN `kegiatan_harian` b on a.`kgtnhari_id` = b.`kgtnhari_id` JOIN `bahan_baku` c on a.`bhnbku_id` = c.`bhnbku_id` WHERE `kgtnhari_id` = 'kgtnhari_id'");
	     	return $result;
	    }
	    ...
	    public function getDataKegiatan_harian_bahan_bakuByID($id){
	    	$result = $this->raw("SELECT * FROM `Kegiatan_harian_bahan_baku` a LEFT JOIN `pengguna` b on a.`pgna_id` = b.`pgna_id` JOIN `jabatan` c on a.`jbtn_id` = c.`jbtn_id` where a.`peg_id` = '$id' ");
	     	return $result;
	    }
